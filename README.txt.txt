This repo contains a supplementary project for benchmarking RandLAPACK's driver-level "Block QR with Randomization and Pivoting" (BQRRP) algorithm.
...
This script relies on the environment variables that are set upon the execution of "install.sh" script and WILL NOT WORK PROPERLY WITHOUT THOSE VARIABLES BEING SET APPROPRIATELY.
