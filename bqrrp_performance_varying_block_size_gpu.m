function[] = bqrrp_performance_varying_block_size_gpu()
    Data_in = readfile('Data_in/2025_02/H100/BQRRP_speed_comparisons_block_size/2025_03_06_BQRRP_GPU_speed_comparisons_block_size_num_info_lines_6.txt', 6);
...
function[] = process_and_plot(Data_in, num_block_sizes, rows, cols, plot_position, show_labels, y_lim)
    ...
    if show_labels 
        switch plot_position
            ...
            case 2
                ylabel('dim = 16,384; GigaFLOP/s', 'FontSize', 20);
            case 3
                ylabel('dim = 8,192; GigaFLOP/s', 'FontSize', 20);
            case 4
                ylabel('dim = 4,096; GigaFLOP/s', 'FontSize', 20);
            case 5
                ylabel('dim = 2,048; GigaFLOP/s', 'FontSize', 20);
